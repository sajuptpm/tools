...
#following site.
sudo wget https://www.digicert.com/CACerts/DigiCertHighAssuranceEVRootCA.crt
--no-check-certificate

#Unfortunately these are encoded and need to be converted into text.
sudo openssl x509 -inform DES -in DigiCertHighAssuranceEVRootCA.crt -out
DigiCertHighAssuranceEVRootCA.crt -text
